...
public class PlayerMovement : MonoBehaviour {
	...
	{
        if (collision.gameObject.tag == "Platform" || collision.gameObject.tag == "Water" || collision.gameObject.tag == "Slime" || collision.gameObject.tag == "Spawned Slime" || collision.gameObject.tag == "Wooden Box") {
